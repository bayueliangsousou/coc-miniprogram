...
const WEAPONS_BY_SKILL = {
  ...
  "射击（步枪/霰弹枪）": [
    ...
    { "name": ".45 马提尼-亨利步枪", "damage": "1D8+1D6+3", "era": "1920s" },
    { "name": ".444 马林步枪（现代）", "damage": "2D8+4", "era": "现代" },
    ...
    { "name": "加兰德 M1、M2 步枪", "damage": "2D6+4", "era": "二战及以后" },
    { "name": "7.62mm SKS 半自动步枪（现代）", "damage": "2D6+1", "era": "现代" },
    { "name": ".303 李-恩菲尔德步枪", "damage": "2D6+4", "era": "1920s,现代" },
    { "name": ".30-06(7.62mm) 栓动步枪", "damage": "2D6+4", "era": "1920s,现代" },
    ...
    { "name": ".58 春田燧发步枪", "damage": "1D10+4", "era": "罕见" },
    { "name": "莫兰上校的气动步枪", "damage": "2D6+1", "era": "1920s" },
    { "name": ".30-06(7.62mm) 半自动步枪", "damage": "2D6+4", "era": "现代" },
    { "name": "双管猎象枪", "damage": "3D6+4", "era": "1920s,现代" }
  ],
  "射击（炮术）": [
