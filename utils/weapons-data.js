...
const WEAPONS_BY_SKILL = {
  "射击（冲锋枪）": [
    ...
    { "name": "MP5", "damage": "1D10", "era": "现代" },
    { "name": "MAC-11", "damage": "1D10", "era": "现代" },
    { "name": "蝎式冲锋枪", "damage": "1D8", "era": "现代" },
    { "name": "汤普森冲锋枪", "damage": "1D10+2", "era": "1920s" },
    { "name": "乌兹微型冲锋枪", "damage": "1D10", "era": "现代" }
  ],
  "格斗（剑）": [
  ...
  "射击（手枪）": [
    { "name": "电击枪(远程)", "damage": "1D3+眩晕", "era": "现代" },
  ...
  "射击（机枪）": [
    ...
    { "name": "M60 通用机枪", "damage": "1D10+2", "era": "现代" },
  ...
  "射击（步枪/霰弹枪）": [
    ...
    { "name": "半自动霰弹枪(12号)", "damage": "2D6", "era": "现代" },
    { "name": ".22 栓动步枪", "damage": "1D6+1", "era": "1920s,现代" },
    { "name": ".30 杠杆步枪", "damage": "2D6", "era": "1920s,现代" },
    { "name": ".45 马提尼-亨利步枪", "damage": "1D10+4", "era": "1920s" },
    { "name": ".444 马林步枪", "damage": "2D8", "era": "现代" },
    { "name": "5.56mm M16 突击步枪", "damage": "2D6", "era": "现代" },
    { "name": "5.56mm M4 卡宾枪", "damage": "2D6", "era": "现代" },
    { "name": "7.62mm AK-47 突击步枪", "damage": "2D6+1", "era": "现代" },
    { "name": "7.62mm M1 加兰德步枪", "damage": "2D6+1", "era": "1920s" },
    { "name": "7.62mm SKS 半自动步枪", "damage": "2D6+1", "era": "现代" },
    ...
    { "name": ".50 BMG 狙击步枪", "damage": "2D10+4", "era": "现代" },
    { "name": "7.62mm 狙击步枪", "damage": "2D6+1", "era": "现代" },
    { "name": "电击枪(近战)", "damage": "1D3+眩晕", "era": "现代" },
    { "name": "信号枪(近战)", "damage": "1D6+燃烧", "era": "1920s,现代" },
    { "name": "鱼叉枪", "damage": "1D8", "era": "现代" },
    { "name": "燃烧瓶", "damage": "1D6+燃烧", "era": "1920s,现代" },
    { "name": "莫洛托夫鸡尾酒", "damage": "1D6+燃烧", "era": "1920s,现代" },
    { "name": "火箭推进榴弹", "damage": "3D10", "era": "现代" }
  ],
  "射击（炮术）": [
    { "name": "37mm 反坦克炮", "damage": "4D10", "era": "1920s,现代" },
    { "name": "75mm 野战炮", "damage": "4D10", "era": "1920s,现代" },
    { "name": "81mm 迫击炮", "damage": "4D10", "era": "1920s,现代" },
    { "name": "120mm 迫击炮", "damage": "6D10", "era": "现代" },
    { "name": "坦克炮", "damage": "10D10", "era": "现代" }
  ],
  "射击（重武器）": [
    { "name": "M72 LAW 火箭筒", "damage": "3D10", "era": "现代" },
    { "name": "RPG-7 火箭筒", "damage": "3D10", "era": "现代" },
    { "name": "M79 榴弹发射器", "damage": "2D10", "era": "现代" },
    { "name": "M203 榴弹发射器", "damage": "2D10", "era": "现代" },
    { "name": "手榴弹", "damage": "2D10", "era": "1920s,现代" },
    { "name": "枪榴弹", "damage": "2D10", "era": "1920s,现代" },
    { "name": "反坦克地雷", "damage": "4D10", "era": "现代" },
    { "name": "阔剑地雷", "damage": "3D10", "era": "现代" },
    { "name": "C4 炸药", "damage": "4D10", "era": "现代" },
    { "name": "TNT 炸药", "damage": "4D10", "era": "1920s,现代" },
    { "name": "塑胶炸药", "damage": "4D10", "era": "现代" },
    { "name": "破片手雷", "damage": "2D10", "era": "1920s,现代" },
    { "name": "闪光弹", "damage": "眩晕", "era": "现代" },
    { "name": "烟雾弹", "damage": "无", "era": "1920s,现代" },
    { "name": "催泪瓦斯", "damage": "眩晕", "era": "现代" },
  ...
  "格斗（电锯）": [
    { "name": "小型电锯", "damage": "1D6", "era": "现代" },
    { "name": "中型电锯", "damage": "1D8", "era": "现代" },
    { "name": "大型电锯", "damage": "2D6", "era": "现代" },
    { "name": "链锯", "damage": "2D8", "era": "现代" }
  ],
  "格斗（绞索）": [
  ...
  "爆破": [
    ...
    { "name": "遥控炸弹", "damage": "4D10", "era": "现代" },
    { "name": "诡雷", "damage": "3D10", "era": "现代" },
